...
if ( $show_author ) {
	...
	printf( _x( 'By %s', 'Post meta info: author.', '1io' ), '<a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '"><span>' . get_the_author_meta( 'display_name', get_the_author_meta( 'ID' ) ) . '</span></a>' );
	echo '</span>';
}
