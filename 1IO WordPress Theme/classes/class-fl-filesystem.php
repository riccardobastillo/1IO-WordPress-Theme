...
class FL_Theme_Filesystem {
	...
	/**
	 * fl_file_get_contents using wp_filesystem.
	 * @since 2.0.6
	 */
	function fl_file_get_contents( $path ) {
	...
	/**
	 * fl_file_put_contents using wp_filesystem.
	 * @since 2.0.6
	 */
	function fl_file_put_contents( $path, $contents ) {
